...
*RegistrarManagerApi* | [**consolidate_identity_using_token**](perun_openapi/docs/RegistrarManagerApi.md#consolidate_identity_using_token) | **GET** /json/registrarManager/consolidateIdentityUsingToken | Joins current user identity with the one previously provided and referenced by the token.
...
*ResourcesManagerApi* | [**assign_resource_tag_to_resource**](perun_openapi/docs/ResourcesManagerApi.md#assign_resource_tag_to_resource) | **POST** /json/resourcesManager/assignResourceTagToResource | Assigns ResourceRag to resource. The ResourceTag must contain its id, voId and tagName.
...
*ResourcesManagerApi* | [**remove_resource_tag_from_resource**](perun_openapi/docs/ResourcesManagerApi.md#remove_resource_tag_from_resource) | **POST** /json/resourcesManager/removeResourceTagFromResource | Removes ResourceRag from a resource. The ResourceTag must contain its id, voId and tagName.
...
*ServicesManagerApi* | [**get_assigned_services**](perun_openapi/docs/ServicesManagerApi.md#get_assigned_services) | **GET** /json/servicesManager/getAssignedServices | List all services associated with the facility (via resource).
*ServicesManagerApi* | [**get_data_with_groups**](perun_openapi/docs/ServicesManagerApi.md#get_data_with_groups) | **GET** /json/servicesManager/getDataWithGroups | Generates the list of attributes per each member associated with the resources and groups.
*ServicesManagerApi* | [**get_data_with_vos**](perun_openapi/docs/ServicesManagerApi.md#get_data_with_vos) | **GET** /json/servicesManager/getDataWithVos | Generates the list of attributes per each member associated with the resources and groups in vos.
...
*ServicesManagerApi* | [**get_flat_data**](perun_openapi/docs/ServicesManagerApi.md#get_flat_data) | **GET** /json/servicesManager/getFlatData | Generates the list of attributes per each user and per each resource. Never return member or member-resource attribute.
...
*ServicesManagerApi* | [**get_hierarchical_data**](perun_openapi/docs/ServicesManagerApi.md#get_hierarchical_data) | **GET** /json/servicesManager/getHierarchicalData | Generates the list of attributes per each member associated with the resource.
...
*UsersManagerApi* | [**change_non_authz_password_by_token**](perun_openapi/docs/UsersManagerApi.md#change_non_authz_password_by_token) | **POST** /urlinjsonout/usersManager/changeNonAuthzPassword/token | Changes user password in defined login-namespace based on token parameter.
*UsersManagerApi* | [**change_password_for_login**](perun_openapi/docs/UsersManagerApi.md#change_password_for_login) | **POST** /urlinjsonout/usersManager/changePassword/login | Changes password for a user in specified login-namespace.
*UsersManagerApi* | [**change_password_for_user**](perun_openapi/docs/UsersManagerApi.md#change_password_for_user) | **POST** /urlinjsonout/usersManager/changePassword/user | Changes password for a user in specified login-namespace.
*UsersManagerApi* | [**check_password_reset_request_by_token_is_valid**](perun_openapi/docs/UsersManagerApi.md#check_password_reset_request_by_token_is_valid) | **GET** /json/usersManager/checkPasswordResetRequestIsValid/token | Checks if the password reset request is valid.
*UsersManagerApi* | [**check_password_strength**](perun_openapi/docs/UsersManagerApi.md#check_password_strength) | **GET** /json/usersManager/checkPasswordStrength | Check password strength for the given namespace.
*UsersManagerApi* | [**create_alternative_password**](perun_openapi/docs/UsersManagerApi.md#create_alternative_password) | **POST** /urlinjsonout/usersManager/createAlternativePassword | Creates alternative password in external system.
...
*UsersManagerApi* | [**delete_alternative_password**](perun_openapi/docs/UsersManagerApi.md#delete_alternative_password) | **POST** /urlinjsonout/usersManager/deleteAlternativePassword | Deletes alternative password in external system.
...
*UsersManagerApi* | [**reserve_password_for_login**](perun_openapi/docs/UsersManagerApi.md#reserve_password_for_login) | **POST** /urlinjsonout/usersManager/reservePassword/login | Reserves password for a user in specified login-namespace.
...
## Documentation For Models
 ...
 - [AttributeAllOf](perun_openapi/docs/AttributeAllOf.md)
 - [AttributeDefinition](perun_openapi/docs/AttributeDefinition.md)
 - [AttributeDefinitionAllOf](perun_openapi/docs/AttributeDefinitionAllOf.md)
 ...
 - [AuditableAllOf](perun_openapi/docs/AuditableAllOf.md)
 - [Author](perun_openapi/docs/Author.md)
 - [AuthorAllOf](perun_openapi/docs/AuthorAllOf.md)
 - [Authorship](perun_openapi/docs/Authorship.md)
 - [AuthorshipAllOf](perun_openapi/docs/AuthorshipAllOf.md)
 - [AuthzRoles](perun_openapi/docs/AuthzRoles.md)
 - [Ban](perun_openapi/docs/Ban.md)
 - [BanAllOf](perun_openapi/docs/BanAllOf.md)
 - [BanOnFacility](perun_openapi/docs/BanOnFacility.md)
 - [BanOnFacilityAllOf](perun_openapi/docs/BanOnFacilityAllOf.md)
 - [BanOnResource](perun_openapi/docs/BanOnResource.md)
 - [BanOnResourceAllOf](perun_openapi/docs/BanOnResourceAllOf.md)
 - [BanOnVo](perun_openapi/docs/BanOnVo.md)
 - [BanOnVoAllOf](perun_openapi/docs/BanOnVoAllOf.md)
 ...
 - [FacilityAllOf](perun_openapi/docs/FacilityAllOf.md)
 ...
 - [GenMemberDataNode](perun_openapi/docs/GenMemberDataNode.md)
 - [Group](perun_openapi/docs/Group.md)
 - [GroupAllOf](perun_openapi/docs/GroupAllOf.md)
 ...
 - [HostAllOf](perun_openapi/docs/HostAllOf.md)
 - [Identity](perun_openapi/docs/Identity.md)
 - [InlineResponse200](perun_openapi/docs/InlineResponse200.md)
 ...
 - [InputCreateCategory1](perun_openapi/docs/InputCreateCategory1.md)
 ...
 - [InputCreateSponsoredMember1](perun_openapi/docs/InputCreateSponsoredMember1.md)
 ...
 - [MemberAllOf](perun_openapi/docs/MemberAllOf.md)
 ...
 - [PublicationAllOf](perun_openapi/docs/PublicationAllOf.md)
 - [PublicationForGUI](perun_openapi/docs/PublicationForGUI.md)
 - [PublicationForGUIAllOf](perun_openapi/docs/PublicationForGUIAllOf.md)
 - [PublicationSystem](perun_openapi/docs/PublicationSystem.md)
 - [PublicationSystemAllOf](perun_openapi/docs/PublicationSystemAllOf.md)
 - [RTMessage](perun_openapi/docs/RTMessage.md)
 - [Resource](perun_openapi/docs/Resource.md)
 - [ResourceAllOf](perun_openapi/docs/ResourceAllOf.md)
 ...
 - [RichFacilityAllOf](perun_openapi/docs/RichFacilityAllOf.md)
 - [RichGroup](perun_openapi/docs/RichGroup.md)
 - [RichGroupAllOf](perun_openapi/docs/RichGroupAllOf.md)
 - [RichMember](perun_openapi/docs/RichMember.md)
 - [RichMemberAllOf](perun_openapi/docs/RichMemberAllOf.md)
 - [RichResource](perun_openapi/docs/RichResource.md)
 - [RichResourceAllOf](perun_openapi/docs/RichResourceAllOf.md)
 - [RichUser](perun_openapi/docs/RichUser.md)
 - [RichUserAllOf](perun_openapi/docs/RichUserAllOf.md)
 - [RichUserExtSource](perun_openapi/docs/RichUserExtSource.md)
 - [RichUserExtSourceAllOf](perun_openapi/docs/RichUserExtSourceAllOf.md)
 ...
 - [ServiceAllOf](perun_openapi/docs/ServiceAllOf.md)
 - [ServiceAttributes](perun_openapi/docs/ServiceAttributes.md)
 - [ServiceForGUI](perun_openapi/docs/ServiceForGUI.md)
 - [ServiceForGUIAllOf](perun_openapi/docs/ServiceForGUIAllOf.md)
 - [ServiceState](perun_openapi/docs/ServiceState.md)
 - [ServicesPackage](perun_openapi/docs/ServicesPackage.md)
 - [ServicesPackageAllOf](perun_openapi/docs/ServicesPackageAllOf.md)
 ...
 - [SimpleAttribute](perun_openapi/docs/SimpleAttribute.md)
 ...
 - [TaskResultAllOf](perun_openapi/docs/TaskResultAllOf.md)
 ...
 - [ThanksAllOf](perun_openapi/docs/ThanksAllOf.md)
 - [ThanksForGUI](perun_openapi/docs/ThanksForGUI.md)
 - [ThanksForGUIAllOf](perun_openapi/docs/ThanksForGUIAllOf.md)
 ...
 - [UserAllOf](perun_openapi/docs/UserAllOf.md)
 - [UserExtSource](perun_openapi/docs/UserExtSource.md)
 - [UserExtSourceAllOf](perun_openapi/docs/UserExtSourceAllOf.md)
 ...
 - [VoAllOf](perun_openapi/docs/VoAllOf.md)
